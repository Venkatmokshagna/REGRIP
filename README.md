...
| Service | URL |
|---|---|
| Frontend | _Deploy to Vercel — https://frontend-ebgtyll5l-venkatmokshagnas-projects.vercel.app/login |
| Backend API | _Deploy to Railway/Render — https://regrip-production.up.railway.app/ |
